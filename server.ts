...
7. EXCLUSIÓN DE CABECERAS Y FIRMAS EN "texto_redactado": Redacta exclusivamente el cuerpo de desarrollo.
    - Si el tipo es "Carta", el saludo debe ser directo y profesional: "Mediante el presente me dirijo a usted, ..." o "Por medio de la presente, ...". Nada de "cordial y afectuoso saludo". El cierre del cuerpo debe ser una oración natural (ej: "Quedo a la espera de su respuesta." o similar). Prohibido el uso de "hago propicia la oportunidad" o frases rebuscadas.
...
8. ESTILO DIRECTO Y CONCRETO (PROHIBIDO FLUF): Prohibido usar frases como "cordial y afectuoso saludo", "me permito poner de relieve", "hago propicia la oportunidad", "muestras de consideración y estima personal" o cualquier lenguaje rebuscado. Use lenguaje profesional pero directo. Cada párrafo debe contener información sustantiva extraída del documento de referencia. Prohibido escribir párrafos genéricos que solo prometan acciones sin sustento concreto. No repita ideas. Sea tan breve como el contenido lo permita.
